...
class Item extends React.Component {
    ...
    render () {
        const { item, qty, units, price, total, isTotal, removeItem } = this.props;
        ...
        return (
            <li className={itemClass}> 
                ...
                {!isTotal && <button className="sub-item sub-item--delete" onClick={removeItem}>
                    <svg xmlns="http://www.w3.org/2000/svg" width="13" height="13" fill="currentColor" class="bi bi-dash" viewBox="0 0 16 16">
